...
lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1.setBounds(58,
        64,
        85,
        14); panel.add(lblNewLabel_1);
JLabel lblNewLabel_1_1 = new JLabel("Subject 2");
lblNewLabel_1_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1_1.setBounds(58,
        101,
        85,
        14);
panel.add(lblNewLabel_1_1);
JLabel lblNewLabel_1_1_1 = new JLabel("Subject 3");
lblNewLabel_1_1_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1_1_1.setBounds(58,
        141,
        85,
        14);
panel.add(lblNewLabel_1_1_1);
JLabel lblNewLabel_1_1_1_1 = new JLabel("Total Marks");
lblNewLabel_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1_1_1_1.setBounds(58,
        182,
        85,
        14);
panel.add(lblNewLabel_1_1_1_1);
JLabel lblNewLabel_1_1_1_1_1 = new JLabel("Average");
lblNewLabel_1_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1_1_1_1_1.setBounds(58,
        218,
        85,
        14);
panel.add(lblNewLabel_1_1_1_1_1);
JLabel lblNewLabel_1_1_1_1_1_1 = new JLabel("Grade");
lblNewLabel_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN,
        12));
lblNewLabel_1_1_1_1_1_1.setBounds(58,
        257,
        85,
        14);
panel.add(lblNewLabel_1_1_1_1_1_1);
sub1 = new JTextField(); sub1.setBounds(164,
        62,
        110,
        20);
panel.add(sub1); sub1.setColumns(10);
sub2 = new JTextField(); sub2.setColumns(10); sub2.setBounds(164,
        99,
        110,
        20); panel.add(sub2);
sub3 = new JTextField(); sub3.setColumns(10); sub3.setBounds(164,
        139,
        110,
        20); panel.add(sub3);
totalmarks = new JTextField(); totalmarks.setColumns(10);
totalmarks.setBounds(164,
        180,
        110,
        20); panel.add(totalmarks);
average = new JTextField(); average.setColumns(10);
average.setBounds(164,
        216,
        110,
        20);
panel.add(average);
...
btnExit.setFont(new Font("Tahoma", Font.PLAIN,
        12));
btnExit.setBounds(356,
        215,
        68,
        39);
panel.add(btnExit);
